...
def plot_conservation(T_taxa,conservation_score_fn,alignment_fn,pid,DELPHI_result_fn):
    ##################
    #plot conservation
    ##################
    x_values = []
...
def main():
    ...
    plot_conservation(T_taxa,conservation_score_fn,alignment_fn,pid,DELPHI_result_fn)
